...
public final class ItemAchievementBinding implements ViewBinding {
  ...
  private ItemAchievementBinding(@NonNull MaterialCardView rootView,
      @NonNull LottieAnimationView celebrationAnimation, @NonNull ImageView imageIcon,
      @NonNull TextView textDescription, @NonNull TextView textTitle) {
    this.rootView = rootView;
    this.celebrationAnimation = celebrationAnimation;
  ...
  public static ItemAchievementBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.celebrationAnimation;
      LottieAnimationView celebrationAnimation = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ItemAchievementBinding((MaterialCardView) rootView, celebrationAnimation,
          imageIcon, textDescription, textTitle);
    }
